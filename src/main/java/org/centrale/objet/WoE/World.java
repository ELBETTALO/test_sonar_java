...
public class World {
    ...
    /**
     * Liste des elements dans l'inventaire
     */
    ...
    /**
     * La map representer avec une matrice où l'indice [i][j] signifie la
     * position (i,j)
     */
    int[][] Mat = new int[tailleW[0]][tailleW[1]];
    /**
     * Une matrice qui represante l'emplacement des objets dans la map
     */
    ...
    /**
     * permet de positionner lesprotagonistes d'une maniére aléatoire
     */
    ...
    /**
     * Genere aleatoirement les objets du monde
     */
    ...
    /**
     * permet la creation d'un joueur dans un monde
     *
     * @return
     */
