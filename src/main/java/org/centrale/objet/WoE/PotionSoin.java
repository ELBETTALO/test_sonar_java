...
/**
 *Classe PotionSoin : permet la creation et la manipulation d'une Potion de
 * soin
...
public class PotionSoin extends Objet implements Utilisable {
    ...
    /**
     * permet de generer une potion avec un score aleatoire
     */
    ...
    /**
     * Permet d'ajouter le score au point de vie d'une creature C
     *
     * @param c Creature
     */
    ...
    /**
     * Save une potion soin dans la base des données
     *
     ...
     * @param i le nombre de la potion soin qu'on va sauvegarder par rapport au autres objets
     */
    @Override
    ...
    /**
     * Get Potionsoin from database
     * @param connection la connection de la base des données
     * @param id id de la sauvegarde
     * @param id_inventaire id de l'inventaire
     * @param nom_potion nom de la potionSoin
     */
    @Override
